...
PanelAB5::PanelAB5(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::PanelAB5)
{
    ui->setupUi(this);
...
void PanelAB5::on_verticalSlider_valueChanged(int value)
{
    ui->label_SliderValue->setText(QString::number(value/10.0, 'f', 1));
}

//REF is not part of sys_map
void PanelAB5::on_pushButton_A_clicked()
{
...
void PanelAB5::on_pushButton_B_clicked()
{
    QPushButton *pb = (QPushButton *)sender();
    radio_button(pb);
    //send to main program
